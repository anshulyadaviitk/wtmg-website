    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-12 space-y-20">
        ...
        <section className="relative">
          <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Faculty Awards</h2>
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Guest Editor Roles</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Student Achievements</h2>
            ...
            <table className="min-w-full bg-white rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-200">
                {awards.students.map((award) => (
                  <tr key={award.id}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{award.recipient}</td>
                    <td className="px-6 py-4 text-sm text-gray-700">
                      {award.title}
                      {award.paperTitle && <p className="text-xs text-gray-500 mt-1">{award.paperTitle}</p>}
                    </td>
